...
// @downloadURL  https://ysraestudos.github.io/km-sin-sidebar-userscript/releases/1.0.18/sin-inline.user.js
...
<html lang="pt-BR">
  ...
  class UnspscQuickFillApp {
    ...
    sync() {
      ...
      if (!native) {
        if (this.host && !this.host.isConnected) this.clearHostRefs();
        return;
      }
